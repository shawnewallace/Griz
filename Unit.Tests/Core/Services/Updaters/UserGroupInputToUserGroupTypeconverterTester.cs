...
{
	[TestFixture]
	public class UserGroupInputToUserGroupTypeconverterTester : TestBase
	{
		[Test]
		public void Should_add_new_usergroup()
		{
			...
			var converter = new UserGroupInputToUserGroupTypeConverter(userRepository,userGroupRepository);

			UserGroup mapped = converter.Convert(form);
